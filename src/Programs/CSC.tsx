...
export default function CSC() {
  return (
    <div>
      <div
        className="relative h-auto py-10 md:h-[500px] w-full bg-cover bg-center flex justify-center items-center font-josefin"
        style={{
      ...
      >
        ...
        <div className="relative z-10 text-center px-6 lg:px-12">
          ...
          <h1 className="text-white text-xl md:text-3xl lg:text-4xl font-bold leading-relaxed lg:leading-tight mb-6 max-w-4xl mx-auto font-lato">
            The Cyber Space Conference is the annual learning technology
            conference for young people, parents and educators, formerly named
            Teens Code Conference produced by Teens Can Code and Virtually Safe.
          </h1>
        </div>
      </div>

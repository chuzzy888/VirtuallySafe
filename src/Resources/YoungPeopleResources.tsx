...
import ypr from "../assets/images/awc.jpg";
  ...
  return (
    <div>
        ...
        <div className=" mx-auto px-6 md:px-12 grid grid-cols-1 md:grid-cols-2 items-center gap-10">
          ...
          <div className="space-y-6 max-w-xl">
            ...
            <h1 className="text-xl md:text-2xl  leading-tight font-nouvelr">
              Virtual safety resources tips and tools for young people to stay
              safe online.
            </h1>
            <p className="text-gray-300 text-lg font-lato">
              Our curated digital safety resources help young people make
              informed choices while navigating the online world.
            </p>
            <div>
      ...
      <section className="w-full bg-[#851FEC] font-nouvelr py-10 relative overflow-hidden">
        <Layout>
          <div className="grid grid-cols-1 px-5  md:grid-cols-2 gap-16 items-center">
            {/* Left - Text Content */}
            <div className="text-white  md:px-8 ">
              <h2 className="text-2xl lg:text-5xl font-extrabold leading-snug">

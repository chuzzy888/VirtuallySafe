...
import img1 from "../assets/images/hmpimg1.png";
import img2 from "../assets/images/hmpimg2.png";
import img3 from "../assets/images/hmpimg3.png";
import img4 from "../assets/images/hmpimg4.png";
  ...
  return (
    <div>
      <div className="relative h-[500px] md:min-h-screen  w-full flex justify-center items-center text-center">
        ...
        <div className="relative z-10 w-full px-4 md:px-12">
          <div className="max-w-4xl mx-auto">
            {/* Title */}
            <h1 className="text-4xl sm:text-5xl md:text-7xl lg:text-7xl font-bold text-white mb-6 leading-tight animate-fade-in font-josefin">
              {slides[currentSlide]}
            </h1>
            ...
            <div className="flex justify-center">
              <button className="flex gap-1 items-center bg-green-500 hover:bg-green-600 text-white px-6 py-3 text-sm sm:text-lg md:text-xl font-semibold rounded-full md:rounded-lg border border-2 transition-all duration-300 transform  font-josefin">
      ...
      >
        <div className="container mx-auto px-4">
          {/* Section Title */}
          <h2 className="text-center text-xl font-bold mb-8 font-josefin text-[#00294B] underline decoration-1 font-josefin">
            What we do
          </h2>
          ...
          <div className="space-y-12">
            ...
            <div className="flex flex-col md:flex-row-reverse items-center justify-center md:gap-20">
              <img src={img2} alt="Advocacy Policy" className="object-cover" />
            ...
            <div className="flex flex-col md:flex-row items-center justify-center md:gap-20">
              <img src={img3} alt="Create Tools" className=" object-cover" />
              <div className="mt-6 md:mt-0 md:ml-8 text-center md:text-left">
                <h3 className="md:text-3xl text-xl font-bold font-josefin text-[#00294B]">
                  Create Tools
                </h3>
      ...
      <section className="bg-[#00294B] text-white px-4 md:px-12 py-10 md:py-16 font-josefin">
        <h2 className="text-[#61CE70] text-center font-semibold text-lg md:text-lg mb-4 underline decoration-1 font-josefin ">
          About Us
        </h2>
        ...
        <div className="flex flex-col md:flex-row items-center gap-6 md:gap-12">
          ...
          <div className="w-full md:w-2/3 text-sm md:text-base leading-relaxed text-start ">
            <p className=" text-lg font-black md:text-xl leading-relaxed  mb-8 ">
              We believe that the issues that young people face online do not
              stay online. They impact on our families, our schools, our
              communities, and the nation at large.
            </p>
            <p className="mb-4 text-[#F9F9F9] text-lg">
              This is the reason we have in recent times experienced record
              levels of bullying in our schools, depression amongst young
              people, self-harm, anxiety, identity theft, exploitation and what
              we call online “gbas gbos” in Nigeria. And we all pay for these
              harms, it is not a case of the “polluter pays” principle, the
              consequences are borne by the whole of society and the emotional
              costs by young people.
            </p>
            <p className="mb-8 text-[#F9F9F9] text-lg ">
              This is why protecting children and young people is a shared
              responsibility and it is upon all relevant stakeholders to ensure
              a sustainable future for all. For that to happen, parents,
              careers, educators, policy makers, industries, and other
              stakeholders, must ensure that children and young people can
              fulfil their potential both online and offline.
            </p>
      ...
      >
        {/* Our Goal */}
        <h2 className="text-[#174F66] text-center md:text-start text-lg md:text-base font-semibold  underline decoration-[#174F66] font-josefin mb-2 md:mb-0">
          Our Goal
        </h2>

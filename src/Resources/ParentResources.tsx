...
import omr from "../assets/images/sss.jpg";
        ...
        <div className=" mx-auto px-6 md:px-12 grid grid-cols-1 md:grid-cols-2 items-center gap-10">
          <div className="relative flex justify-center">
            <div className="relative w-full max-w-lg">
              <img
                src="https://res.cloudinary.com/karotcloud/image/upload/v1740598753/IMG_1698_rdpzur.jpg"
                alt="Mission banner"
          ...
          <div className="space-y-6 max-w-xl">
            ...
            <h1 className="text-xl md:text-2xl  leading-tight font-nouvelr">
              Virtual Safety Resources Tips and Tools for Parents to Keep Their
              Children Safe Online.
            </h1>
            <p className="text-gray-300 text-lg font-lato">
              A collection of expert-curated resources to help parents guide
              their children through safe and responsible online behavior.
            </p>
            <div>

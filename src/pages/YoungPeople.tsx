...
import ypg from "../assets/images/ypg.png";
    ...
    <div>
      ...
      >
        ...
        <div className="relative z-10 text-center px-4">
          ...
          <h1 className="text-white text-xl md:text-5xl lg:text-6xl font-bold leading-tight mb-6 ">
      ...
      <section className="bg-[#851FEC] text-white px-6 md:px-12 py-10 md:py-16 font-josefin">
        <h2 className="text-white text-center font-semibold text-lg md:text-lg mb-4 underline decoration-1 font-josefin ">
          We serve Young People
        </h2>
        <p className="text-center text-sm md:text-xl leading-relaxed max-w-3xl mx-auto mb-8 font-black">

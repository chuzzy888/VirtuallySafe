...
import pimg from "../assets/images/pr.png";
    ...
    <div>
      ...
      >
        ...
        <div className="relative z-10 text-center px-6 md:px-10 lg:px-20 max-w-5xl">
          ...
          <h1 className="text-white text-xl md:text-4xl lg:text-5xl font-nouvelr font-extrabold leading-tight mb-6">
            Virtual Safety Resources: Tips and tools for parents to navigate and
            stay safe online.
          </h1>
        </div>
      </div>
      ...
      <section className="w-full">
        ...
        <div className="bg-[#851FEC] font-nouvelr">
          <Layout>
